...
const data = [{ label: "Set  1", value: "1" }];
...
const WorkoutAdd = ({ route }) => {
  ...
  const loginUser = async () => {
    try {
      console.log("sWorkoutSetName :", WorkoutName);
      console.log("sSetsNo :", SetNo);
      console.log("sWeight :", Weight);
      console.log("sReps :", Reps);

      const { data } = await axios.post(
        "https://engistack.com/test_reactapp/workoutadd.php",
        {
          iWorkoutId: iWorkoutId,
          sWorkoutSetName: WorkoutName,
          sSets: SetNo,
          sWeight: Weight,
          sReps: Reps,
        }
