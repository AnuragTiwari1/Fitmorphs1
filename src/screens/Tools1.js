...
const Tools1 = ({ navigation, route }) => {
  const [index, setIndex] = React.useState(0);

  const { iChallengeId } = route.params;
  ...
  const getUserData = () => {
    axios
      .get("https://engistack.com/test_reactapp/challenge1data.php", {
        params: {
          iChallengeId: iChallengeId,
        },
      })
                    ...
                    renderItem={({ item }) => {
                      ...
                      return (
                        <Card containerStyle={{ borderRadius: 30 }}>
                          ...
                          <Text
                            style={{ flex: 1, paddingLeft: 5, fontSize: 12 }}
                          >
                            {item.sAbout}
                          </Text>
                          <Text
